...
public class DeviceControlActivity extends Activity {
            ...
            new ExpandableListView.OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        String charAddress = characteristic.getUuid().toString();
                        String serviceAddress = characteristic.getService().getUuid().toString();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStopButton = (Button) findViewById(R.id.stopBroadcast);
    ...
    public void startDataAcquisition(String deviceName, String deviceAddress, String serviceAddress, String charAddress) {
        final Intent intent = new Intent(this, DataDisplayActivity.class);
